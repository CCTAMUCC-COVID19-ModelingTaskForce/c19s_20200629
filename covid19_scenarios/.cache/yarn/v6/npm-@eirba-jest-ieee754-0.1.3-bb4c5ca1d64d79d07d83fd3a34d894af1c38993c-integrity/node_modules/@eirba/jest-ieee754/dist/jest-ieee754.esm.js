...
var State = /*#__PURE__*/function () {
  ...
  _createClass(State, [{
    ...
    get: function get() {
      return existsSync(this.snapshotState._snapshotPath);
    }
  }]);
...
function compare(want, got, maxUlp) {
  ...
  return want.every(function (_, idx) {
    return ulpDistance(want[idx], got[idx]) <= maxUlp;
  });
}
...
//# sourceMappingURL=jest-ieee754.esm.js.map
